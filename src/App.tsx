...
function ChessBoard({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
  ...
  return (
    <div className={`${dim} grid grid-cols-8 rounded-2xl overflow-hidden shadow-2xl border-2 border-[#c9c1b5]/50`}>
      {Array.from({ length: 64 }, (_, i) => {
        ...
        return (
          <div key={i} className={`aspect-square flex items-center justify-center ${light ? "bg-[#F0E4D0]" : "bg-[#B8956A]"}`}>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bento-grid">
          ...
          <motion.button initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
            ...
            <h3 className="font-display text-xl font-semibold text-[#2C1810] mb-2">AI Dashboard</h3>
